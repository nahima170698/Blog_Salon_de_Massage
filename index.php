...
<head>
    ...
    <title>Blog_Salon_de_Massage</title>
...
<body>
    ...
    <header id="navbar">
        <nav id="menu">
            <ul>
                <ul class="linkmenu"><a class="lien btn" href="#"><img id="logo" src="https://massage-theme.richardpruzek.com/wp-content/uploads/2020/04/massage_logo_header-1.png"></a></ul>
            </ul>
            <ul id="lienentête">

                <ul>
                    <a class="lien btn" href="#">HOMEPAGE<i class="fa-solid fa-chevron-down fa-2xs" style="color: #abb8c3;"></i></a>
                </ul>
                <ul>
                    <a class="lien btn" href="#">ABOUT US<i class="fa-solid fa-chevron-down fa-2xs" style="color: #abb8c3;"></i></a>

                </ul>
                <ul>
                    <a class="lien btn" href="#">PAGES & PROJECTS<i class="fa-solid fa-chevron-down fa-2xs" style="color: #abb8c3;"></i> </a>

                </ul>
                <ul>
                    <a class="lien btn" href="#">BLOG<i class="fa-solid fa-chevron-down fa-2xs" style="color: #abb8c3;"></i> </a>
        ...
        <section id="sect1">
            <div class="section">
                ...
                <h1 id="titre">WELCOME <br>
                    <strong>IN BEAUTY PARADISE</strong>
                </h1>
        ...
        <div id="margedufooter">
            <div id="fin_page">
                ...
                <ul class="uldebas">
                    ...
                    <li class="contacts"><img class="logobas" src="https://massage-theme.richardpruzek.com/wp-content/uploads/2020/02/icon11.png" alt="">
                        <p>+49 8568 523 525 <br>
                            +43 8568 856 235</p>
                    </li>
                    <li class="contacts"><img class="logobas" src="https://massage-theme.richardpruzek.com/wp-content/uploads/2020/02/icon07.png" alt="">
                        <p>info@massage.com <br>
                            hello@myspa.de</p>
                    </li>
                    <li class="contacts"><img class="logobas" src="https://massage-theme.richardpruzek.com/wp-content/uploads/2020/02/icon09.png" alt="">
                        <p>info@massage.com <br>
                            helo@myspa.de</p>
                    </li>
                </ul>
